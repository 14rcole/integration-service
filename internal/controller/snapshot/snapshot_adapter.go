...
func (a *Adapter) createIntegrationPipelineRun(integrationTestScenario *v1beta2.IntegrationTestScenario) (*tektonv1.PipelineRun, error) {
	...
	// TODO: remove this block and replace namespace with a.componentGroup.Namespace
	// once old application model is deprecated
	...
	pipelineRunBuilder, err := tekton.NewIntegrationPipelineRun(a.client, a.context, a.loader, a.logger, integrationTestScenario.Name, namespace, integrationTestScenario, a.snapshot)
	if err != nil {
		return nil, err
	}
